...
@objc public protocol ParalloxViewDelegate:NSObjectProtocol {
...
open class ParalloxView: UIView {
	
	/// Animatable constraints
	@IBOutlet weak public var bodyViewTopConstraint: NSLayoutConstraint?
	@IBOutlet weak public var headerViewHeightConstraint: NSLayoutConstraint?
